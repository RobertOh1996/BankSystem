...
/**
 * Business savings account representation for an account.
 * 
...
public class BusinessSavingsAccount extends Account {
	...
	/**
	 * Defines the basic representation of a business savings account.
	 * 
	 * @param accountNumber: The initial account number assigned to the account.
	 */
	public BusinessSavingsAccount(String accountNumber) {
		super(accountNumber, AccountType.BUSINESS_SAVINGS_ACCOUNT);
	}

	/**
	 * Used to reconstruct a business savings account representation from a file.
	 * 
	 ...
	 */
	public BusinessSavingsAccount(String accountNumber, AccountType type, BigDecimal balance, AccountDAO accountDAO,

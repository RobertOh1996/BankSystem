...
/**
 * Personal savings account representation for an account.
 * 
...
public class PersonalSavingsAccount extends Account {
	 ...
	 */
	private static final BigDecimal MONTHLY_FEE_WAIVED_MINIMUM_BALANCE = new BigDecimal("500.00");

	private boolean minimumMonthlyFeeBalanceWaived;

	/**
	 * Defines the basic representation of a personal savings account.
	 * 
	 * @param accountNumber: The initial account number assigned to the account.
	 */
	public PersonalSavingsAccount(String accountNumber) {
		super(accountNumber, AccountType.PERSONAL_SAVINGS_ACCOUNT);
	}

	/**
	 * Used to reconstruct a personal savings account representation from a file.
	 * 
	 ...
	 */
	public PersonalSavingsAccount(String accountNumber, AccountType type, BigDecimal balance, AccountDAO accountDAO,
